...
- [Bun](https://bun.sh) - A fast all-in-one JavaScript runtime with a built-in package manager
...
```
git clone git@github.com:iraycd/bun-vite-react-boilerplate.git
```

Changing into the new directory

```
cd bun-vite-react-boilerplate
```
